...
# Pfad zur Ausgabedatei angeben
ausgabedatei = '/Users/moritz/PycharmProjects/TeamprojektDataScience/08_Reany_Auswertung/Ranking Frenco Messungen/Auswertung'  # Ersetze '/Pfad/zum/Ranking.csv' durch den gewünschten Dateipfad

# Ranking in CSV speichern
ergebnis.to_csv(ausgabedatei, index=False)
